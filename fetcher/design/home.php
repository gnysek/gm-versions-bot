...
<a class="btn btn-success btn-small" href="<?php echo URL; ?>release/<?php echo $name; ?>">Release notes &amp; Download &raquo;</a>
...
<?php foreach ($gmapis as $name => $data): ?>
	...
	<div class="row">
		...
		<div class="span4"><?php echo get_version($name, $resultFile); ?></div>
		<div class="span4">
